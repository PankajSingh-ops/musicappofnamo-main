...
export default function PublisherAuthScreen({navigation}: any) {
  return (
    <View style={styles.container}>
      <Image
        ...
        style={styles.logo}
      />
      <Text style={styles.title}>LET THE MUSIC BEGINS</Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('PublisherRegister')}>

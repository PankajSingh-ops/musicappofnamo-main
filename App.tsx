...
import EventsDetails from './src/Events/EventsDetails/EventsDetails';
import SupportForm from './src/auth/Support/SupportForm';
      ...
      <MusicProvider>
        <NavigationContainer>
          <Stack.Navigator
            ...
            <Stack.Screen
              name="PublisherAuth"
              component={PublisherAuthScreen}
            />
            <Stack.Screen name="Register" component={RegisterScreen} />
            <Stack.Screen
              name="PublisherRegister"
              component={PublisherRegisterScreen}
            />
